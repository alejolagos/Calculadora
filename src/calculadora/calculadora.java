...
public static String calculadora(String memoria1,String memoria2,String signo)
{
    ...
    if( !(memoria1.equals("") || memoria2.equals("") || signo.equals("")) )
    {
        if(validarNumericoSigno(memoria1,memoria2,signo))
        {
            if(validarDivisionPorCero(memoria2,signo))
            {
                if (signo.equals("-"))
                {
  ...
  public static boolean validarNumericoSigno(String memoria1,String memoria2,String signo)
  {
      if((isNumeric(memoria1)&&isNumeric(memoria2))==true)
      {
  ...
  public static boolean validarDivisionPorCero(String memoria2,String signo)
  {
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        String cadena;
        boolean existeP=existeUnPunto(txtpantalla.getText());
        ...
        System.out.println("Existe Un Punto: "+existeP);
    ...
    private void txtpantallaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtpantallaKeyTyped
        ...
        if( txtpantalla.getText().length()>=8 ) evt.consume();
        if(( car<'0' || car>'9' )) evt.consume();
    }//GEN-LAST:event_txtpantallaKeyTyped

    public static boolean existeUnPunto(String cadena)
    {
        boolean resultado;
        resultado=false;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() 
            {
                //controlador ExisteUnPunto
                System.out.println("Entrada : 1.0");
                System.out.println("Salida Obtenida: "+existeUnPunto("1.0"));
                
                System.out.println("Entrada : ");
                System.out.println("Salida Obtenida: "+existeUnPunto(""));
